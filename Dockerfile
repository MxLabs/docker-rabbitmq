...
RUN apk add --no-cache curl && \
    ...
    rabbitmq-plugins enable --offline rabbitmq_shovel rabbitmq_shovel_management rabbitmq_delayed_message_exchange rabbitmq_consistent_hash_exchange rabbitmq_prometheus && \
    apk del curl
